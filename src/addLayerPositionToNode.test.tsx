...
test('one node in one layer ', () => {
    let nodes = [{elements: [{name: "group 1", elements: [{name: "node 1"}]}]}];
...
test('two nodes in one layer', () => {
    let nodes = [{elements: [{name: "group 1", elements: [{name: "node 1"}, {name: "node 2"}]}]}];

    addLayerPositionToNode(nodes);

    expect(nodes)
        .toStrictEqual([{elements: [{name: "group 1", elements: [
            {name: "node 1", key: "0_0", index: 0, relativePosition: 0, layerIndex: 0},
...
test('three nodes in one layer ', () => {
    let nodes = [{elements: [{name: "group 1", elements: [{name: "node 1"}, {name: "node 2"}, {name: "node 3"}]}]}];
...
test('two nodes and one node in two layers ', () => {
    let nodes = [
        {elements: [{name: "group 1", elements: [{name: "node 1"}, {name: "node 2"}]}]},
        {elements: [{name: "group 2", elements: [{name: "node 3"}]}]}
    ];
