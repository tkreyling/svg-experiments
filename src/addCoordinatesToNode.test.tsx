...
test('one element is layouted to the origin', () => {
    ...
    let expected: Layer<Node & LayerPosition & X & Y & LayerDimensions, GroupPosition & X & Y & Height> = {
        kind: 'layer', elements: [{
...
test('one element in the second layer keeps space for the two borders between the layers', () => {
    ...
    let expected: Stack<Node & LayerPosition & X & Y & LayerDimensions, GroupPosition & X & Y & Height> = {
        kind: 'stack', elements: [{
            kind: 'layer', elements: [{
